        ...
        while (SDL_PollEvent(&e) != 0) {
            ...
            if (e.type == SDL_QUIT)
                ...
                if (SetWindowSize1920x1080 && !SetWindowSize1280x720 && !SetWindowSize800x600) {
                    ...
                    if (inSettingsPage) {
                        handle_mouse_button_down(e, 460, 760, 570, 681, play_sound, clickButton); // Первая кнопка
                        ...
                        handle_mouse_button_down(e, 720, 920, 815, 890, play_sound,
                                                 clickButton); // Кнопка "Настройка 1"
                        handle_mouse_button_down(e, 1020, 1220, 815, 890, play_sound,
                                                 clickButton); // Кнопка "Настройка 2"
                    }
                }
                ...
                if (!SetWindowSize1920x1080 && SetWindowSize1280x720 && !SetWindowSize800x600) {
                    ...
                    if (inSettingsPage) {
                        ...
                        handle_mouse_button_down(e, 510, 645, 540, 595, play_sound, clickButton);
                        handle_mouse_button_down(e, 695, 830, 540, 595, play_sound, clickButton);
                    }
                }
                ...
                if (!SetWindowSize1920x1080 && !SetWindowSize1280x720 && SetWindowSize800x600) {
                    ...
                    if (inSettingsPage) {
                        ...
                        handle_mouse_button_down(e, 300, 390, 455, 495, play_sound, clickButton);
                        handle_mouse_button_down(e, 450, 540, 455, 495, play_sound, clickButton);
                    }
                }
